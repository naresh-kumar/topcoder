// https://www.codechef.com/SEPT15/status/MGCH3D,nemausus
// https://www.codechef.com/viewplaintext/8119700
//author Naresh
#include <algorithm>
#include <bitset>
#include <cassert>
    ...
    rep(i, 0, n) {
      rep(j, 0, n) {
        if (i != j) {
          ...
          int z = points[i].z - points[j].z;
          ans += abs(a*x + b*y + c*z + d)/sqrt(x*x*x*x + y*y*y*y + z*z*z*z);
        }
      }
    }
    ans = ans / n;
