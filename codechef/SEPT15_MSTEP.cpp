// https://www.codechef.com/SEPT15/status/MSTEP,nemausus
// https://www.codechef.com/viewplaintext/8018454
//author Naresh
#include <algorithm>
#include <bitset>
#include <cassert>
...
int main() {
  ...
  while(tests--) {
    ...
    rep(i, 1, n*n) {
      auto curr = v[i];
      ans += abs(v[i].first - last.first) + (ll)abs(v[i].second - last.second);
      last = curr;
    }
    println(ans);
  }
