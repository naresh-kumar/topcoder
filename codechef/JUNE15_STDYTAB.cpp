// https://www.codechef.com/JUNE15/status/STDYTAB,nemausus
// https://www.codechef.com/viewplaintext/7203859
//author Naresh
#include <algorithm>
#include <bitset>
#include <iostream>
...
ll getNcr(ll n, ll r) { return factorial(n)/(factorial(r) * factorial(n-r)); }
...
int ncr[4000][2000];
int main() {
  //freopen("/Users/knaresh/topcoder/cpp/in.txt", "r", stdin);
